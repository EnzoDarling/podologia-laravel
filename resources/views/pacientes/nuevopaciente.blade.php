...
<div class="bg-white p-4 my-5 rounded">
  ...
  <form action="{{route('crearpaciente')}}" method="POST">
    ...
    <div class="form-group mt-4">
      ...
      <input type="text" name="apellido" id="apellido" class="form-control @error('apellido') border border-danger @enderror" placeholder="Apellido del Paciente" value="{{ old('apellido') }}">
      @error('apellido')
    ...
    <div class="form-group my-2">
      ...
      <input type="text" name="nombre" id="nombre" class="form-control @error('nombre') border border-danger @enderror" placeholder="Nombre del Paciente" value="{{ old('nombre')}}">
      @error('nombre')
        <div class="text-danger">{{$message}}</div>
      @enderror
    </div>
